        ...
        <div className="card bg-base-100 shadow-xl ">
            ...
            <div className=" ">
                <div className="card-body space-y-3">
                    ...
                    <hr className="" />
                    <div className="flex flex-col lg:flex-row flex-wrap text-sm gap-2">
                        {
                            facilities.map((facility, index) => <span className="px-2 py-1 rounded-2xl bg-slate-700 text-white" key={index}> {facility} </span>)
                        }
                    </div>
                </div>
